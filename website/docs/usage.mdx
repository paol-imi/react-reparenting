...
If you are developing a library I suggest you take a look at the `useParent()` hook [here](./useparent). It is a lower level tool _(internally used by the `<Reparentable>`)_ and allows for more flexibility.

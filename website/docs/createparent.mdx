...
If you want to use another component as parent, you can provide a function that defines that component _(You need to know a bit the structure of React fibers)_.

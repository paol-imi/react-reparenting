...
### SendReparentableChild( fromParentId, toParentId, child, position, [skipUpdate] ): index ⚙️
...
| --------- | ------------------------- | ------------------------------------------------------------------------------------------ |
| children  | _ReactNode_               | The children that can be transferred.                                                      |
| parentRef | _React.Ref<ParentFiber\>_ | The ref of the ParentFiber instance. <br/><br/> **Required**                               |
| findFiber | _func_                    | A function to change the parent fiber. <br/><br/> **Signature** `(parent: fiber) => fiber` |
